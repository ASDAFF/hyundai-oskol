...
?>
    ...
    <script>
        ...
        jQuery(function($){
            $('.main-nav__item--has-submenu').click(function(){
                console.log(123);

                if($('.submenu').hasClass() == "_active"){
    ...
    <link type="text/css" href="css/roundslider.css" rel="stylesheet" />
    ...
    <main class="main" data-model="home">
        ...
        <div class="plus">
            <div class="plus__x">
                <svg role="presentation" class="svg icon_svg--close-fullsize">
                    <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#close"></use>
                </svg>
            </div>
            <div class="plus__back">
                <div class="plus__wrapper">
                    <a href="javascript:void(0)" class="plus__link link zing_form_toggler_spec" for="testdrive">
        ...
        <section class="hero s-wrapper">
            <div class="hero__image s-inner"><img src="img/hero2.png" alt="" class="hero__image hero__img"/>
                <div class="hero__text"><strong class="hero__uptitle s-title">Новинка</strong>
                    <h1 class="hero__title">Hyundai Tucson<br/>комплектация Active</h1>
                    <h2 class="hero__subtitle">Городской кроссовер стал доступнее!</h2>
                </div>
                <div class="hero__label">
                    <div class="hero__label-price"><span>от</span> 1 449 900 ₽</div>
                    <div class="hero__label-notice">По программе «Старт»</div>
                    <div class="hero__label-monthly">от 10 000 ₽ в месяц</div>
                </div>
            </div><a href="javascript:void(0)" class="hero__scroll-down"><span>Узнать больше</span>
                <svg role="presentation" class="svg hero__scroll-icon">
                    <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#arrow_scroll"></use>
                </svg></a>
        </section>
        <section class="feat s-wrapper">
            <div class="feat__inner s-inner">
                <div class="feat__side feat__side--left">
                    <video preload="preload" muted="muted" data-object-fit="cover">
                        <source src="http://www.hyundai.ru/media/tucson_landing/images/feat.mp4" type="video/mp4"/>
                    </video>
                    <h3 class="feat__label s-title s-title--is-top-left">Особенности</h3>
                </div>
                <div class="feat__side feat__side--right">
                    <div class="feat__info">
                        <h2 class="feat__title">Легенда стала доступнее.</h2>
                        <p class="feat__text">Новая базовая комплектация Active - высокий уровень оснащения и сниженная цена.</p>
                    </div><a href="javascript:void(0)" class="feat__load link">
                        <svg role="presentation" class="svg icon_svg--doc-fullsize link__icon">
                            <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#d_arrow"></use>
                        </svg><span class="link__text"><span>Посмотреть особенности</span></span></a>
                </div>
            </div>
        </section>
        <section class="advantages js-advantages">
            <div class="advantages__half-bg"></div>
            <div class="advantages__counter js-advantages-counter">
                <div class="advantages__counter--item js-active-advantage">01</div>
            </div>
            <div class="advantages__wrapper">
                <div class="advantages__tabs js-advantages-slider swiper-container">
                    <div class="advantages__tabs--pagination js-tab-pagination">
                        <div class="advantages__tabs--pagination--wrapper"><a href="javascript:;" class="advantages__tabs--item js-tab-item">Экстерьер</a><a href="javascript:;" class="advantages__tabs--item js-tab-item">Интерьер</a><a href="javascript:;" class="advantages__tabs--item js-tab-item">Динамика</a><a href="javascript:;" class="advantages__tabs--item js-tab-item">Безопасность</a><a href="javascript:;" class="advantages__tabs--item js-tab-item">Комфорт</a>
                        </div>
                        <div class="advantages__tabs--pagination--rail">
                            <div class="advantages__tabs--pagination--line js-tabs-line"></div>
                        </div>
                    </div>
                    <div class="advantages__tabs--wrapper swiper-wrapper">
                        <div class="advantages__tabs--content swiper-slide js-images-swiper-container">
                            <div class="advantages__item">
                                <div class="advantages__item--left">
                                    <div class="advantages__item--bg _text"></div>
                                    <div class="advantages__item--content">
                                        <div class="advantages__item--type">Экстерьер</div>
                                        <div class="advantages__item--text-slider js-text-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Экстерьер</div>
                                                    <div class="advantages__item--descr">Стремительный и смелый. Настоящий внедорожник, пробуждающий бурю эмоций.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Диски 17</div>
                                                    <div class="advantages__item--descr">Элегантные 17-дюймовые легкосплавные диски добавляют автомобилю привлекательности.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Задний спойлер</div>
                                                    <div class="advantages__item--descr">Tucson оснащен задним аэродинамическим спойлером с высоко расположенным стоп-сигналом.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Противотуманные фары</div>
                                                    <div class="advantages__item--descr">Интегрированные противотуманные фары обеспечат отличную видимость и безопасное движение в плохую погоду.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Светодиодные дневные ходовые огни</div>
                                                    <div class="advantages__item--descr">Светодиодные дневные ходовые огни придают автомобилю современный, незабываемый образ.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="advantages__item--nav">
                                        <button class="advantages__item--btn _prev js-images-slider-prev">
                                            <svg role="presentation" class="svg icon_svg--arrow_prev-fullsize advantages__item--svg">
                                                <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#arrow_prev"></use>
                                            </svg>
                                        </button>
                                        <div class="advantages__item--counter"><span class="advantages__item--counter--active js-counter-active">1</span><span class="advantages__item--counter--separator">/</span><span class="advantages__item--counter--all">5</span></div>
                                        <button class="advantages__item--btn _next js-images-slider-next">
                                            <svg role="presentation" class="svg icon_svg--arrow_next-fullsize advantages__item--svg">
                                                <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#arrow_next"></use>
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                <div class="advantages__item--right">
                                    <div class="advantages__item--bg _slider">
                                        <div class="advantages__item--slider js-images-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/exterior/5.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/exterior/1.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/exterior/2.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/exterior/3.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/exterior/4.png" class="advantages__item--image"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="advantages__tabs--content swiper-slide js-images-swiper-container">
                            <div class="advantages__item">
                                <div class="advantages__item--left">
                                    <div class="advantages__item--bg _slider">
                                        <div class="advantages__item--slider js-images-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/interior/2.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/interior/1.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/interior/3.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/interior/4.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/interior/5.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/interior/6.png" class="advantages__item--image"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="advantages__item--nav">
                                        ...
                                        <div class="advantages__item--counter"><span class="advantages__item--counter--active js-counter-active">1</span><span class="advantages__item--counter--separator">/</span><span class="advantages__item--counter--all">6</span></div>
                                        <button class="advantages__item--btn _next js-images-slider-next">
                                            <svg role="presentation" class="svg icon_svg--arrow_next-fullsize advantages__item--svg">
                                                <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#arrow_next"></use>
                                            </svg>
                                ...
                                <div class="advantages__item--right">
                                    <div class="advantages__item--bg _text"></div>
                                    <div class="advantages__item--content">
                                        <div class="advantages__item--type">Интерьер</div>
                                        <div class="advantages__item--text-slider js-text-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Интерьер</div>
                                                    <div class="advantages__item--descr">Салон Hyundai Tucson - сочетание современных технологий и изящных деталей отделки.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Большой багажник</div>
                                                    <div class="advantages__item--descr">Обширное пространство для багажа (458 л.) дополнительно увеличивается за счет складывания задних сидений и шторки багажника до 1478 л.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Отделка руля и рукоятки КПП кожей</div>
                                                    <div class="advantages__item--descr">Рулевое колесо и рукоятка КПП покрыты мягкой высококачественной кожей.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Охлаждаемый перчаточный ящик</div>
                                                    <div class="advantages__item--descr">Ваши напитки всегда останутся прохладными во вместительном охлаждаемом перчаточном ящике.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Регулировка угла наклона спинок заднего сиденья</div>
                                                    <div class="advantages__item--descr">Для большего удобства пассажиров положение наклона спинки задних сидений можно легко изменить.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Шторка багажника</div>
                                                    <div class="advantages__item--descr">Шторка необходима как для безопасности, так и для удобства: она позволяет скрыть содержимое багажного отделения и предотвратит попадание багажа в салон.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="advantages__tabs--content swiper-slide js-images-swiper-container">
                            <div class="advantages__item">
                                <div class="advantages__item--left">
                                    <div class="advantages__item--bg _text"></div>
                                    <div class="advantages__item--content">
                                        <div class="advantages__item--type">Динамика</div>
                                        <div class="advantages__item--text-slider js-text-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Двигатель</div>
                                                    <div class="advantages__item--descr">Бензиновый двигатель 2.0 MPi с максимальной мощностью 149,6 л.с. при 6 200 об/мин. и максимальным крутящим моментом 192 Нм при 4 000 об/мин. обеспечивает прекрасную динамику.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">КПП автомат</div>
                                                    <div class="advantages__item--descr">Автоматическая 6-ступенчатая трансмиссия наделяет Tucson плавностью переключения и комфортом в движении. Кроме того, существенно улучшена динамика разгона, экономичность двигателя и снижены выбросы CO2.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="advantages__item--nav">
                                        ...
                                        <div class="advantages__item--counter"><span class="advantages__item--counter--active js-counter-active">1</span><span class="advantages__item--counter--separator">/</span><span class="advantages__item--counter--all">2</span></div>
                                        <button class="advantages__item--btn _next js-images-slider-next">
                                            <svg role="presentation" class="svg icon_svg--arrow_next-fullsize advantages__item--svg">
                                                <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#arrow_next"></use>
                                            </svg>
                                ...
                                <div class="advantages__item--right">
                                    <div class="advantages__item--bg _slider">
                                        <div class="advantages__item--slider js-images-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/dynamics/1.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/dynamics/2.png" class="advantages__item--image"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="advantages__tabs--content swiper-slide js-images-swiper-container">
                            <div class="advantages__item">
                                <div class="advantages__item--left">
                                    <div class="advantages__item--bg _slider">
                                        <div class="advantages__item--slider js-images-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/safety/1.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/safety/2.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/safety/3.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/safety/4.png" class="advantages__item--image"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="advantages__item--nav">
                                        ...
                                        <div class="advantages__item--counter"><span class="advantages__item--counter--active js-counter-active">1</span><span class="advantages__item--counter--separator">/</span><span class="advantages__item--counter--all">4</span></div>
                                        <button class="advantages__item--btn _next js-images-slider-next">
                                            <svg role="presentation" class="svg icon_svg--arrow_next-fullsize advantages__item--svg">
                                                <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#arrow_next"></use>
                                            </svg>
                                ...
                                <div class="advantages__item--right">
                                    <div class="advantages__item--bg _text"></div>
                                    <div class="advantages__item--content">
                                        <div class="advantages__item--type">Безопасность</div>
                                        <div class="advantages__item--text-slider js-text-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">ESC</div>
                                                    <div class="advantages__item--descr">Благодаря системе стабилизации ESC, притормаживающей заднее внутреннее колесо еще до начала скольжения автомобиля, риск заноса на поворотах сведен к минимуму.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Подушки безопасности</div>
                                                    <div class="advantages__item--descr">Система из 6 подушек безопасности включает в себя две фронтальные подушки, две боковые передние подушки и две шторки безопасности с обеих сторон по всей длине салона.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Эра-Глонасс</div>
                                                    <div class="advantages__item--descr fs14">Государственная система экстренного реагирования при авариях «ЭРА-ГЛОНАСС» – это использование технологий ГЛОНАСС в целях повышения безопасности на транспорте. Кроме того, только на автомобилях Hyundai в случае непредвиденных ситуаций, при которых требуется техническая помощь (эвакуация, запуск двигателя, замена или ремонт колеса, вскрытие дверей, отключение сигнализации, подвоз топлива), через систему «ЭРА-ГЛОНАСС» вы можете вызвать помощь на дороге.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Система мониторинга давления в шинах</div>
                                                    <div class="advantages__item--descr">Интеллектуальная система контроля давления в шинах точно определяет, в каком из колес давление упало ниже допустимого.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="advantages__tabs--content swiper-slide js-images-swiper-container">
                            <div class="advantages__item">
                                <div class="advantages__item--left">
                                    <div class="advantages__item--bg _text"></div>
                                    <div class="advantages__item--content">
                                        <div class="advantages__item--type">Комфорт</div>
                                        <div class="advantages__item--text-slider js-text-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Bluetooth с системой распознавания голоса</div>
                                                    <div class="advantages__item--descr">Голосовое управление очень удобно и безопасно.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Датчик света с автоматическим включением фар</div>
                                                    <div class="advantages__item--descr">Боковая лампа автоматически загорается вместе с сигналом поворота, увеличивая видимость в темное время суток.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Круиз-контроль с управлением на руле</div>
                                                    <div class="advantages__item--descr">Система поддерживает постоянную скорость, заданную водителем.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title lines3">Система антизапотевания стекол</div>
                                                    <div class="advantages__item--descr">Cистема решит проблему запотевания до того, как вы ее заметите. Определив конденсацию на лобовом стекле, система запускает климат-контроль, что повышает видимость и безопасность.</div>
                                                </div>
                                                <div class="swiper-slide advantages__item--text-slide">
                                                    <div class="advantages__item--title">Двухзонный климат-контроль</div>
                                                    <div class="advantages__item--descr">Система индивидуального управления климат-контролем позволяет водителю и переднему пассажиру настроить оптимальную температуру по своему усмотрению.</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="advantages__item--right">
                                    <div class="advantages__item--bg _slider">
                                        <div class="advantages__item--slider js-images-slider swiper-container">
                                            <div class="swiper-wrapper">
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/comfort/1.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/comfort/2.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/comfort/3.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/comfort/4.png" class="advantages__item--image"></div>
                                                </div>
                                                <div class="advantages__item--slide swiper-slide">
                                                    <div data-bg="img/comfort/5.png" class="advantages__item--image"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="supercalc">
            <div id="calc"></div>
            <div class="calc">
                <div class="calc-label s-title s-title--is-top-left">Ваш расчет</div>
                <div class="calc-box">
                    <div class="calc__box">
                        <div class="calc_bg"></div>
                        <div class="calc__widget"></div>
                        <div class="calc__info">
                            <div class="calc__label">Старт</div>
                            <div class="calc__price startprice">31 580</div>
                            <div class="calc__line">
                                <div style="width:60%;" class="calc__line-scale start-scale"></div>
                            </div>
                            <div class="calc__label">Стандартный кредит</div>
                            <div class="calc__price tprice">31 580</div>
                            <div class="calc__line">
                                <div class="calc__line-scale full-scale"></div>
                            </div>
                            <div class="calc__button calculator-btn">Отправить на email</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script id="start-credit" data-classlist="start-credit-template-modal" type="text/sp-template">
            <div class="start-credit__body">
                ...
                <form class="form" data-form-id="start-credit-form" accept-charset="utf-8" novalidate="novalidate">
                    ...
                    <div class="form-row">
                        <input class="text-input" id="start-credit-email-name" type="text" name="first_name" data-empty="Заполните поле" placeholder="Вопрос"
                    </div>
                    <div class="form-row form-row--agreement">
                        <input class="checkbox-input" id="start-credit-agreement" type="checkbox" name="agree" data-wrong="Согласитесь с правилами" value="Y" checked>
        ...
        <section class="video">
            <video preload="preload" muted="muted" data-object-fit="cover">
                <source src="http://www.hyundai.ru/media/tucson_landing/images/video.mp4" type="video/mp4"/>
            </video>
            <div class="video__poster"></div>
            <div class="video__inner s-inner">
                <div class="video__label s-title s-title--is-top-left">Видео</div>
                <div class="video__panel">
                    <div class="video__panel-side video__panel-side--left"><a href="javascript:void(0);" class="pulse-btn">
                            <div class="pulse-btn__circle pulse-btn__circle_first"></div>
                            <div class="pulse-btn__circle"></div>
                            <svg role="presentation" class="svg icon_svg--play-fullsize pulse-btn__icon">
                                <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#play"></use>
                            </svg></a>
                    </div>
                    <div class="video__panel-side video__panel-side--right">
                        <div class="video__title">Tucson Active — решайся!</div>
                    </div>
                </div>
                <ul class="tile-menu tile-menu--in-video">
                    <li class="tile-menu__item"><a href="http://www.hyundai.ru/configurator/car/18/modification" target="_blank" class="tile-menu__link">
                            ...
                            <h4 class="tile-menu__title">Создай свой Tucson</h4>
                            <p class="tile-menu__text">Ваш автомобиль в 3 клика</p></a></li>
                    <li class="tile-menu__item"><a href="#" class="tile-menu__link zing_form_toggler" for="brochures_request" data-model="Tucson">
                            <div class="tile-menu__icon">
                                <svg role="presentation" class="svg icon_svg--doc-fullsize">
                                    <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#doc"></use>
                                </svg>
                            </div>
                            <h4 class="tile-menu__title">Скачать каталог</h4>
                            <p class="tile-menu__text">Узнай больше</p></a></li>
                    <li class="tile-menu__item"><a href="javascript:void(0)" class="tile-menu__link zing_form_toggler_spec" for="testdrive" data-model="Tucson">
                            <div class="tile-menu__icon">
                                <svg role="presentation" class="svg icon_svg--wheel-fullsize">
                                    <use xlink:href="/media/tucson_landing/images/symbols.svg?v=2#wheel"></use>
                                </svg>
                            </div>
                    ...
                    <li class="tile-menu__item"><a href="http://www.hyundai.ru/configurator/car/18/modification#calculator" target="_blank" class="tile-menu__link">
                            ...
                            <h4 class="tile-menu__title">Рассчитать кредит</h4>
                            <p class="tile-menu__text">Финансовые программы</p></a></li>
                </ul>
            </div>
        </section>
    </main>
    ...
    <div class="svg-root" style="position: absolute; width: 0; height: 0; visibility: hidden;">
        ...
        <script src="js/vendors-v=1.js"></script>
        <script src="js/common-v=2.js"></script>
    ...
    <script type="text/javascript" src="js/roundslider.js"></script>
    <script type="text/javascript" src="js/script-v=2.js"></script>

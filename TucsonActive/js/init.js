...
var app = (function ($) {
  ...
  var Application = {
    ...
    initialize: function () {
      ...
      this.modules.Feat.init();
      this.modules.Video.init();
      this.modules.Advantages.init();
      this.modules.Plus.init();
      this.modules.PulseBtn.init();

      app.dom.$htmlbody.scrollTop(0);
    }
...
$(function(){
  ...
  socket.on('update',function(target){
    ...
    switch (target) {
      ...
      case 'scss':
      case 'styl':
        var $styles = $('link[href*="/page-styles.css"]'),

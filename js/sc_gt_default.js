...
$(document).ready(function() {
	...
	var $contrl = $('.js-tab-contrl li'),
		$content = $('.js-tab-content li');
	...
	if (document.getElementById("main")) {
		...
		$(".carlist ul").css("height","51px").css("overflow","visible");
	}
...
*/
	...
	$('.car_selectlist li').hover(function(){
		...
		$(this).find('.thumb').css('background','transparent url(/media/img/configurator/bg_carlist_select_on.png) no-repeat 0 65px');
	...
	if (isMobile==1) {
		...
		touchScroll('package_trim_scroll');
		*/
	}
	/* scripts for spec */
    ...
    // pip print 
        ...
        var printID = '#'+$(this).parents('.pip,.general').attr('id');
        var codeStyle = '<style type="text/css">@media print {.pip,.general { display:none !important; }  '+printID+'{display:block !important;}';
        codeStyle = codeStyle + ' '+printID+'{display:block !important;}';
        if (printID!="#contents_highlights") codeStyle = codeStyle + '.cubebox {display:none !important} ';
        else codeStyle = codeStyle + '.cubebox {display:block !important;overflow:hidden !important;} ';
        codeStyle = codeStyle + '.wrap{background:#efefed !important;} }</style><div id="temp"></div>';
        $('body').append(codeStyle);
        if(printID=='#contents_highlights'){
            printFn()
        }else{              
            $(printID+' img').each(function(index, element) {
                if($(this).hasClass('lazy')==true){
                    $(this).attr('src',$(this).attr('data-original'));
                    $(this).removeClass('lazy').removeAttr('data-original');
                    var printImg = $('<img />').load(function(e){
                        $(this).attr('print','print');
                    }).attr('src',$(this).attr('src'));
                    $('#temp').append(printImg);
                };
            });
            var printTimmer = setInterval(function(e){
                if( $('#temp img').length == $('#temp img[print="print"]').length ) {
                    printFn();
                }else{
...
$(window).scroll(function(e){
	...
	if (document.getElementById("floating_top")) {
...
function cubeTalknTalk(num,socialType,profileImg,name,txt,txtLayer) {
	...
	$(".cubebox .cubelist .talkntalk_list ul li.comment"+num+" .name").append('<img src="http://www.hyundai.com/wcm/images/common/icon/icon_cube_talkntalk_'+socialType+'.gif" alt="" /><img src="'+profileImg+'" alt="" class="profile" /> <span>'+name+'</span>');
...
function cubeMostLike(carName,trim,exteriorColor,interiorColor,carImg,seemoreLink,carbuilderLink,likeCode,exteriorColorName,interiorColorName) {
	...
	$(".mostlike_option .option").append('<span><img src="'+exteriorColor+'" alt="" width="28" height="28" /> <img src="http://www.hyundai.com/wcm/images/'+country+'/cube/mostlike_exteriorcolor.png" alt="Exterior Color" class="option_title" /><br>'+exteriorColorName+'</span> <span><img src="'+interiorColor+'" alt="" width="28" height="28" /> <img src="/wcm/images/'+country+'/cube/mostlike_interiorcovering.png" alt="Interior Color" class="option_title" /><br>'+interiorColorName+'</span>'); // ? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢ ? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢ ? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢
...
function cubeExperienceColorList(num,onoff,colorImg) {
	if (onoff=="on") {
		$(".experience_option ul").append('<li class="color'+num+'"><a href="#"><img src="'+colorImg+'" alt="" /></a><br /><span><img src="/media/img/cover_color.png" alt="" /></span></li>');
	} else {
...
function showGalleryLargeLayer(code,carname,titleimg,description,isImg,download,twitter,facebook,stumbleupon,like,isMain) {
	...
	if (isImg=="image") {
		...
		if (isMobile==0) {
			...
			$(".layer_gallery").append('<div class="minimap"><div class="in"><img src="'+code+'" class="small" /><br /><div class="move"><img src="/media/img/blank.gif" alt="" /></div></div></div>');
			...
			$(".layer_gallery .minimap .in .move").draggable({containment:".layer_gallery .minimap .in", cursor:"move",
				...
				stop:function(event) {
					...
					var y = parseInt(parseInt($(this).css("top"))*1152/64) * -1 + parseInt($(window).scrollTop());
...
function galleryPopup() {//0710
	...
	/*
	$(".layer_gallery").height('100%')
	setTimeout(function(e){
		if($('#layer_gallery .img').height()>=$(document).height()){
			$(".layer_gallery").width($(window).width());
		}else{
			$(".layer_gallery").width(w);
		}
	},200);
	*/
...
function scrollAnimation() {
	if(isMobile==0){
		$('a[href*=#wrap], a[href*=#contents_highlights], a[href*=#contents_exterior], a[href*=#contents_interior], a[href*=#contents_safety], a[href*=#contents_convenience], a[href*=#contents_performance], a[href*=#contents_specification], a[href*=#contents_review], a[href*=#contents_accessories], area[href*=#wrap], area[href*=#contents_highlights], area[href*=#contents_exterior], area[href*=#contents_interior], area[href*=#contents_safety], area[href*=#contents_convenience], area[href*=#contents_performance], area[href*=#contents_specification], area[href*=#contents_review], area[href*=#contents_accessories]').click(function() {
			/*
			...
			*/
			if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
				...
				if ($target.length) {
					...
					// jQuery('html,body').stop().animate({scrollTop:targetOffset}, {duration:500, easing:'motion'});
					jQuery('html,body').stop().animate({scrollTop:targetOffset}, {duration:500});
					// jQuery('html,body').animate({scrollTop:targetOffset}, {duration:500, easing:'easeInOutQuart'});
					return false;
				} else {
					return true;
				}
		...
		$('a[href*=#contents_highlights]').click(function() {goToMyId('contents_highlights');});
		$('a[href*=#contents_exterior]').click(function() {goToMyId('contents_exterior');});
		$('a[href*=#contents_interior]').click(function() {goToMyId('contents_interior');});
		$('a[href*=#contents_safety]').click(function() {goToMyId('contents_safety');});
		$('a[href*=#contents_convenience]').click(function() {goToMyId('contents_convenience');});
		$('a[href*=#contents_performance]').click(function() {goToMyId('contents_performance');});
		$('a[href*=#contents_specification]').click(function() {goToMyId('contents_specification');});
		$('a[href*=#contents_review]').click(function() {goToMyId('contents_review');});
		$('a[href*=#contents_accessories]').click(function() {goToMyId('contents_accessories');});
		$('area[href*=#wrap]').click(function() {goToMyId('wrap');});
		$('area[href*=#contents_highlights]').click(function() {goToMyId('contents_highlights');});
		$('area[href*=#contents_exterior]').click(function() {goToMyId('contents_exterior');});
		$('area[href*=#contents_interior]').click(function() {goToMyId('contents_interior');});
		$('area[href*=#contents_safety]').click(function() {goToMyId('contents_safety');});
		$('area[href*=#contents_convenience]').click(function() {goToMyId('contents_convenience');});
		$('area[href*=#contents_performance]').click(function() {goToMyId('contents_performance');});
		$('area[href*=#contents_specification]').click(function() {goToMyId('contents_specification');});
		$('area[href*=#contents_review]').click(function() {goToMyId('contents_review');});
		$('area[href*=#contents_accessories]').click(function() {goToMyId('contents_accessories');});
		if (!location.hash || location.hash=="#wrap") {
			setTimeout(scrollTo, 0, 0, 1);
		} else {
			if (location.hash=="#contents_highlights") {goToMyId('contents_highlights');}
			if (location.hash=="#contents_exterior") {goToMyId('contents_exterior');}
			if (location.hash=="#contents_interior") {goToMyId('contents_interior');}
			if (location.hash=="#contents_safety") {goToMyId('contents_safety');}
			if (location.hash=="#contents_convenience") {goToMyId('contents_convenience');}
			if (location.hash=="#contents_performance") {goToMyId('contents_performance');}
			if (location.hash=="#contents_specification") {goToMyId('contents_specification');}
			if (location.hash=="#contents_review") {goToMyId('contents_review');}
			if (location.hash=="#contents_accessories") {goToMyId('contents_accessories');}
		}
	}
}
function goToMyId(myid) { // ? Ã¬Å’â€?ÂÃ¬Ëœâ„¢ ID? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢? Ã¬Ââ„¢??? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢, ? Ã¬â€¹Â±?Â¸Ã¬Ëœâ„¢? Ã¬â€¹Â¹ÃªÂ³Â¤Ã¬Ëœâ„¢ ? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢, ? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢? Ã¬Ââ„¢??? Ã¬Ââ„¢?â„¢Ã¥Â ?â„¢Ã¬Ëœâ„¢? Ã¬Ââ„¢??
...
function fixedPosition() {
	...
	if ($(window).scrollTop() >= 482) {
		if (isPositionFixed==0) {
			...
			//$(".wrap .floating_cubemenu").css("left",w+10);
		} else {
		...
		$(".wrap .floating_cubemenu").css("position","absolute");
		//$(".wrap .floating_cubemenu").css("left",w-1+10);
	}
...
function fixedPositionScroll() {
	...
	if ($(window).scrollTop() >= 482) {
		...
		$(".wrap .floating_cubemenu").css("top",411);
	}
}
function readyCube() {
		...
		function change_button(num,obj) {
			if (num>0 && num<=pages.length) {
				...
				if (isCube==1) {
					...
					if (num==1) {
						$("div.prevbtn a img").attr("src","/media/img/blank.gif");
					} else {
						if(pip_car_name == "GrandSantaFe") $("div.prevbtn a img").attr("src","/media/img/btn_cube_left_white.png");
						else $("div.prevbtn a img").attr("src","/media/img/btn_cube_left.png");
					}
					if (num==pages.length) {
						$("div.nextbtn a img").attr("src","/media/img/blank.gif");
					} else { 
						if(pip_car_name == "GrandSantaFe") $("div.nextbtn a img").attr("src","/media/img/btn_cube_right_white.png");
						else $("div.nextbtn a img").attr("src","/media/img/btn_cube_right.png");
					}
					// cube motion
					cubeStart(num);
				}
				//if (isCube==0) {
					...
					pages.each(function(i) {
						...
						if (currentPage==now) {
							if (isCube==1) {
								if (isDark == 1){
									tmpTxt = tmpTxt + '<a href="#"><img src="/media/img/bg_pagingtouch_off.png" alt="'+now+'" /></a>';
								} else {
									tmpTxt = tmpTxt + '<a href="#"><img src="/media/img/bg_pagingtouch_on2.png" alt="'+now+'" /></a>';
								}
								
							} else {
								tmpTxt = tmpTxt + '<a href="#"><img src="/media/img/bg_pagingtouch_on.png" alt="'+now+'" /></a>';
							}
						} else {
							if (isDark == 1){
								tmpTxt = tmpTxt + '<a href="#"><img src="/media/img/bg_pagingtouch_on2.png" alt="'+now+'" /></a>';
...
function fn_openAjaxErrorPopup(err){
	...
	$.ajax({
		url : "http://hyundai.com/wcm/common/error/systemErrorPopup.do",
		success : function(htmDoc){
						$("#error_popup").html("");
						$("#error_popup").html(htmDoc);
					},
		error : function(err){
			console.log("Please try again to load error popup");

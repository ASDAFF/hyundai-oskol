...
$(function() {
	...
	function refreshDealers () {
		...
		$.post('/ajax/dealer.php', 'city_id='+cityid, function(res){
	...
	function changeModel () {
		...
		var src = 'http://www.hyundai.ru/media/img/service-pages/cars/car-image--'+_model+'.png';
		$currentModelImg.attr('src', src);

		$.post('http://www.hyundai.ru/requestnew/getserviceengines', 'car=' + _model2, function(res){
	...
	function changeEngine (selector) {
		...
		$.post('http://www.hyundai.ru/requestnew/getserviceenginetypes', 'car=' + _model2 + '&engine=' + _v, function(res){
	...
	function reCalc () {
		...
		if(dealer.length > 0)
		{
			...
			$.post(
				'http://www.hyundai.ru/requestnew/getservicecost',
				{
					car: model2,
					dealer: dealer,
					engine: engine,
...
*/
		...
		if(_valid)
		{
			...
			$.ajax({
				url: 'http://www.hyundai.ru/requestnew/ServiceRequestToCRM',
				type: "POST",
				data: post_data,

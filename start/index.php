...
$APPLICATION->SetPageProperty("title", "Программа Старт Плюс");
$APPLICATION->SetTitle("Программа Старт Плюс");
?>
